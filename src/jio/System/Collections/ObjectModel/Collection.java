...
import jio.System.Collections.Generic.*;public class Collection<T> {public NObject javonetHandle; public Collection (){ try {  javonetHandle = Javonet.New("Collection");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public Collection (IList<T> list){ try {  javonetHandle = Javonet.New("Collection",list);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public Collection(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
