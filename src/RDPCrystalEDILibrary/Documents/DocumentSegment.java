...
import RDPCrystalEDILibrary.*;public abstract class DocumentSegment {protected NObject javonetHandle; /**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public java.lang.String getName (){ try { return  (java.lang.String) javonetHandle.get("Name");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return "";} }public DocumentSegment (){ try {  javonetHandle = Javonet.New("DocumentSegment");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public DocumentSegment (java.lang.String name){ try {  javonetHandle = Javonet.New("DocumentSegment",name);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public DocumentSegment(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
	 ...
	 * Method
	 */
            public void Write (WriteArguments writeArgs){ try { javonetHandle.invoke("Write",writeArgs);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }	static {
		try {
