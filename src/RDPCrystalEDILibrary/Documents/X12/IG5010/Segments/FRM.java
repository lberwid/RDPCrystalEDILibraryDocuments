...
import RDPCrystalEDILibrary.*;public class FRM extends DocumentSegment {protected NObject javonetHandle; /**
	 * SetProperty
	 */
            public void setAssignedIdentification (java.lang.String value){ try { javonetHandle.set("AssignedIdentification",value);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }/**
	 * GetProperty
	 */
            public java.lang.String getAssignedIdentification (){ try { return  (java.lang.String) javonetHandle.get("AssignedIdentification");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return "";} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public java.lang.String getPercent (){ try { return  (java.lang.String) javonetHandle.get("Percent");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return "";} }public FRM (){  super((NObject) null); try {  javonetHandle = Javonet.New("FRM"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public FRM(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
