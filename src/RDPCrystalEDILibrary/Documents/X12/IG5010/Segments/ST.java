...
import RDPCrystalEDILibrary.*;public class ST extends DocumentSegment {protected NObject javonetHandle; /**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public java.lang.String getImplementationConventionReference (){ try { return  (java.lang.String) javonetHandle.get("ImplementationConventionReference");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return "";} }public ST (){  super((NObject) null); try {  javonetHandle = Javonet.New("ST"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public ST(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
