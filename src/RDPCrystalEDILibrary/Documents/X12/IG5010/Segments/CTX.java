...
import RDPCrystalEDILibrary.*;public class CTX extends DocumentSegment {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public ContextIndentification getContextIndentification (){ try { return new ContextIndentification((NObject)javonetHandle.get("ContextIndentification"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
