...
import jio.System.Collections.ObjectModel.*;public class Loops extends Collection<Loop> {public NObject javonetHandle; public Loops (){  super((NObject) null); try {  javonetHandle = Javonet.New("Loops"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public Loops(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
