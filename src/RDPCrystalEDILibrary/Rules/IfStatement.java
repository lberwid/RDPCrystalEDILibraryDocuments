...
import jio.System.Collections.Generic.*;public class IfStatement extends Node {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public Node getFalse (){ try { return new Node((NObject)javonetHandle.get("False"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
