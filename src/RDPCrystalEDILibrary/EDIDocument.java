...
import jio.System.*;public class EDIDocument extends Component {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public Loops getLoops (){ try { return new Loops((NObject)javonetHandle.get("Loops"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
